...
export const Hud: React.FC = () => {
    const { cameraRef, renderCameraRef, cameraVelocityRef, collisionState } = useAppContext();
    ...
    useEffect(() => {
        ...
        const render = () => {
            ...
            let baseColorStr = '93, 64, 55'; // Dark Brown (Studyquest)
            if (currentState === 'approaching') {
                baseColorStr = '141, 110, 99'; // Medium Brown Warning
            } else if (currentState === 'colliding') {
                baseColorStr = '211, 47, 47'; // Red Alert
            }
    ...
    }, [cameraRef, renderCameraRef, cameraVelocityRef]);
